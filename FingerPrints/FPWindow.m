...
- (BOOL) hasSecondaryMirroredScreen
{
    ...
    NSLog(@"hasSecondaryMirroredScreen");
...
{
    NSLog(@"setAlwaysShowFingerPrints");
...
{
    NSLog(@"setShowFingerPrintsInReleaseMode");
